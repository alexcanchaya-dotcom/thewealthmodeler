    ...
    <div className="grid gap-8 lg:grid-cols-2">
      <div className="card space-y-4">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900">State Savings vs bank</h1>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-semibold text-gray-800" htmlFor="termYears">
              Term years
            </label>
            <select
              id="termYears"
          ...
          <div className="sm:col-span-2 flex flex-col gap-2">
            <label className="text-sm font-semibold text-gray-800" htmlFor="productId">
            ...
            <p className="text-xs text-gray-500">{STATE_SAVINGS_AER_HOLD_NOTE}</p>
            <p className="text-xs text-gray-500">{INSTALMENT_SAVINGS_NOTE}</p>
          </div>
          ...
          <div className="flex flex-col justify-end gap-2">
            <p className="text-sm font-semibold text-gray-800">DIRT</p>
        ...
        <p className="text-xs text-gray-500">{STATE_SAVINGS_RATE_FOOTNOTE}</p>
      </div>
        ...
        <div className="card space-y-4">
          {result ? (
            <>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-lg bg-gray-50 px-4 py-3">
                  <p className="text-sm font-semibold text-gray-600">State Savings</p>
                  <p className="mt-1 text-xl font-bold text-gray-900">{formatEuro(result.stateNet)}</p>
                  {product ? (
                ...
                <div className="rounded-lg bg-gray-50 px-4 py-3">
                  <p className="text-sm font-semibold text-gray-600">Bank after DIRT</p>
                  <p className="mt-1 text-xl font-bold text-gray-900">{formatEuro(result.bankNet)}</p>
                  <p className="mt-1 text-xs text-gray-500">
            ...
            <>
              <div>
                <p className="text-sm font-semibold text-gray-600">Result</p>
                <p className="mt-1 text-xl font-bold text-gray-900">{INSTALMENT_SAVINGS_NOTE}</p>
              </div>
              <div className="rounded-lg bg-gray-50 px-4 py-3">
                <p className="text-sm font-semibold text-gray-600">Bank after DIRT</p>
                <p className="mt-1 text-xl font-bold text-gray-900">{formatEuro(bankNet)}</p>
                <p className="mt-1 text-xs text-gray-500">
                  {bankAer.toFixed(2)}% AER · {(DIRT_RATE * 100).toFixed(0)}% DIRT · {effectiveTerm} years
                </p>
              </div>
