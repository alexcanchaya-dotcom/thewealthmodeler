...
export default function RetirementPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Premium feature: Social Security integrator */}
      <PremiumCTA
        feature="Social Security Income Integrator"
        description="Factor in estimated Social Security benefits based on your earnings history to get a more accurate picture of your retirement income."
      />

      {/* Contextual affiliate recommendations */}
      <AffiliateLinks calculator="retirement" />
    </div>
  );
}
