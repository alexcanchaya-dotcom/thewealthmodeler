export const IRELAND_BADGE = 'Ireland — take-home and FIRE using Irish numbers';
...
export const STATE_SAVINGS_AER_HOLD_NOTE = 'State Savings AER assumes hold to term';
export const MORTGAGE_VS_RENT_FOOTNOTE =
